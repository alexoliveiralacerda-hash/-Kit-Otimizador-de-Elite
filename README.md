🚀 Manual do Usuário: Otimizador de Elite v4.0
...
1.	Clique com o botão direito no arquivo Otimizador de Elite v4.0.exe.
...
Verifique o Antivírus: Alguns antivírus podem bloquear scripts de manutenção. Adicione o Otimizador de Elite v4.0.exe à lista de exclusões se necessário.
